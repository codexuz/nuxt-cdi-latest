                    ...
                    <SidebarMenuSub>
                      <SidebarMenuSubItem>
                        <SidebarMenuSubButton
                          as-child
                          :is-active="$route.path === '/admin/leads'"
                        >
                      ...
                      <SidebarMenuSubItem>
                        <SidebarMenuSubButton
                          as-child
                          :is-active="$route.path === '/admin/trial-lessons'"
                        >
                          <NuxtLink to="/admin/trial-lessons">
                            <ClipboardCheck />
                  ...
                  <CollapsibleContent>
                    <SidebarMenuSub>
                      <SidebarMenuSubItem>
                        <SidebarMenuSubButton
                          as-child
                          :is-active="$route.path === '/admin/students'"
                        >
                      ...
                      <SidebarMenuSubItem>
                        <SidebarMenuSubButton
                          as-child
                          :is-active="$route.path === '/admin/groups'"
                        >
                          <NuxtLink to="/admin/groups">
                            <UsersRound />
                            <span>Groups</span>
                          </NuxtLink>
                        </SidebarMenuSubButton>
                      ...
                      <SidebarMenuSubItem>
                        <SidebarMenuSubButton
                          as-child
                          :is-active="$route.path === '/admin/attendance'"
                        >
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton
                  as-child
                  :is-active="$route.path === '/admin/payments'"
                >
