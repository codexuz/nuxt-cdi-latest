  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center">
        <h1
          class="text-4xl font-extrabold text-gray-900 dark:text-white sm:text-5xl lg:text-6xl"
        >
          Choose Your Plan
        </h1>
      ...
      <div class="mt-12 flex justify-center">
        <div
          class="relative bg-white dark:bg-gray-800 p-1 rounded-lg border border-gray-200 dark:border-gray-700"
        >
          <div class="flex">
            <button
            ...
            >
              Yearly
              <span
                class="ml-1 text-xs bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100 px-2 py-0.5 rounded-full"
              >
                Save 20%
              </span>
            </button>
            ...
            <CardContent>
              <div class="space-y-4">
                <div
                  v-for="j in 4"
                  :key="j"
                  class="h-6 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"
                ></div>
              </div>
            </CardContent>
          </Card>
        ...
        <template v-else>
          ...
          >
            ...
            <CardContent>
              <ul class="space-y-4">
                <li
                  v-for="(feature, fIndex) in getFeaturesList(plan.features)"
                  :key="fIndex"
            ...
            <div class="text-center">
              ...
              <div class="mt-4">
                ...
                >
                  {{
                    formatPrice(
                      billingPeriod === "monthly" ? "700000" : "6720000"
                    )
                  }}
                  UZS
                </span>
      ...
      <!-- CTA Section -->
      <div
        class="mt-20 bg-primary text-primary-foreground rounded-2xl px-8 py-16 text-center"
      >
...
async function fetchPlans() {
  try {
    ...
    const response = await fetch(
      `${config.public.baseURL}/subscriptions/plans`,
      {
        headers: {
...
function getFeaturesList(features) {
  ...
  if (features.max_students) {
    featureList.push(
      features.max_students >= 10000
        ? "Unlimited students"
        : `Up to ${features.max_students} students`
    );
  }
  if (features.max_users) {
    featureList.push(
      features.max_users >= 10000
        ? "Unlimited users"
